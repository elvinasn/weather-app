...
/* harmony import */ var _domMarkups__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./domMarkups */ "./src/domMarkups.js");
...
var dom = function () {
  ...
  var init = function init() {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(_helpers__WEBPACK_IMPORTED_MODULE_2__.helpers.callByLocation);
    } else {
      _ControllerAPI__WEBPACK_IMPORTED_MODULE_0__.ControllerAPI.callCityAPI("Vilnius", "metric");
    }
  };
...
var helpers = function () {
  var callByLocation = function callByLocation(location) {
    var lat = location.coords.latitude;
    var lon = location.coords.longitude;
    _ControllerAPI__WEBPACK_IMPORTED_MODULE_0__.ControllerAPI.callCoordAPI(location.coords.latitude, location.coords.longitude, "metric");
  };

  return {
    callByLocation: callByLocation
  };
}();
